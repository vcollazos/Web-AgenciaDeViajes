...
function admin_styles(){
    ...
    // función para producir plantillas de fotos
    wp_localize_script(
        'loginjs',
        'login_imagenes',
        array(
...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('toursDestacado', 705, 391, true); // imagenes destacadas de la página de Tour
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('lightbox', get_template_directory_uri() . '/js/lightbox.min.js', array('jquery'), '2.11.2'); // Lightbox
        wp_enqueue_script('lightbox'); // Enqueue it!

        wp_register_script('bxslider', get_template_directory_uri() . '/js/jquery.bxslider.js', array('jquery'), '4.1.1'); // Lightbox
        wp_enqueue_script('bxslider'); // Enqueue it!

        wp_register_script('slicknav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array('jquery'), '1.0.10'); // Lightbox
...
function html5blank_styles()
{
    ...
    wp_register_style('lightboxcss', get_template_directory_uri() . '/css/lightbox.min.css', array(), '1.0', 'all');
    wp_enqueue_style('lightboxcss'); // Enqueue it!

    wp_register_style('bxslidercss', get_template_directory_uri() . '/css/jquery.bxslider.css', array(), '4.1', 'all');
    ...
    wp_register_style('oxygen', 'https://fonts.googleapis.com/css2?family=Oxygen', array(), '1.0', 'all');
...
add_action('init', 'create_post_type_html5'); // Add our tours Type
...
// función slider de página de Inicio
